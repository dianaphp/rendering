...
class BladePhpStatementsTest extends AbstractBladeTestCase
{
    ...
    public function testPhpStatementsWithoutExpressionAreIgnored()
    {
        ...
        $string = '{{ "Ignore: @php" }}';
        $expected = '<?php echo \Diana\Support\Helpers\Emit::e("Ignore: @php"); ?>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
    }
    ...
    public function testVerbatimAndPhpStatementsDontGetMixedUp()
    {
        ...
        $expected = " {{ Hello, I'm not blade! }}"
            . "\n@php echo 'And I'm not PHP!' @endphp"
            . "\n <?php echo \Diana\Support\Helpers\Emit::e('I am Blade'); ?>"
    ...
    public function testStringWithParenthesisCanBeCompiled()
    {
        ...
        $this->assertSame('<?php echo $__env->make(\'test_for\', [\'issue))\' => \'(issue#45424))\'], \Diana\Support\Helpers\Arr::except(get_defined_vars(), [\'__data\', \'__path\'])); ?>', $this->compiler->compileString('@include(\'test_for\', [\'issue))\' => \'(issue#45424))\'])'));
        $this->assertSame('( <?php echo $__env->make(\'test_for\', [\'not_too_much))\' => \'(issue#45424))\'], \Diana\Support\Helpers\Arr::except(get_defined_vars(), [\'__data\', \'__path\'])); ?>))', $this->compiler->compileString('( @include(\'test_for\', [\'not_too_much))\' => \'(issue#45424))\'])))'));
    }
    ...
    public function testUnclosedParenthesisForBladeTags()
    {
        ...
        $expected = "<span class=\"<?php echo \Diana\Support\Helpers\Arr::toCssClasses([]); ?>\"(['(']></span>";
    ...
    public function testNestedTagCalls()
    {
        ...
        $expected = '<span class="<?php echo \Diana\Support\Helpers\Arr::toCssClasses([\'k\' => @empty($v)]); ?>"></span>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
        ...
        $expected = '<span class="<?php echo \Diana\Support\Helpers\Arr::toCssClasses([\'k\' => @empty($v), \'t\' => @empty($v1)]); ?>"></span>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
        ...
        $expected = '<span class="<?php echo \Diana\Support\Helpers\Arr::toCssClasses([\'k\' => @empty($v), \'t\' => @empty($v1), \'r\' => @empty($v2)]); ?>"></span>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
        ...
        $expected = '<span class="<?php echo \Diana\Support\Helpers\Arr::toCssClasses([\'k\' => @empty($v), \'t\' => @empty($v1), \'r\' => @empty($v2), \'l\' => \'l\']); ?>"></span><span class="<?php echo \Diana\Support\Helpers\Arr::toCssClasses([\'k\' => @empty($v)]); ?>"></span>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
    }
