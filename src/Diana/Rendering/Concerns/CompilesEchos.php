...
trait CompilesEchos
{
    ...
    protected function compileEscapedEchos($value)
    {
        ...
        $callback = function ($matches) {
            ...
            return $matches[1]
                ? $matches[0]
                : "<?php echo \Diana\Support\Helpers\Emit::e({$this->wrapInEchoHandler($matches[2])}); ?>{$whitespace}";
        };
    ...
    protected function wrapInEchoHandler($value)
    {
        ...
        return empty($this->echoHandlers) ? $value : '$__compiler->applyEchoHandler(' . $value . ')';
    }
