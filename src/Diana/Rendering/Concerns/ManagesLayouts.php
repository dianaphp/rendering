...
trait ManagesLayouts
{
    ...
    public function startSection($section, $content = null)
    {
        if ($content === null) {
            ...
            $this->extendSection($section, $content instanceof View ? $content : \Diana\Support\Helpers\Emit::e($content));
        }
    }
    ...
    {
        $sectionContent = $default instanceof View ? $default : \Diana\Support\Helpers\Emit::e($default);
